...
(begin (define x 2) (define y 3) (test x y))
; expect 6

(define (statements val) 
  (cond
    ((= val 0) #f)
    ((> val 0) 1)
    (else -1)
...
(and (statements 0) (test 5 5))
; expect #f
(or (statements 0) (test 5 5))
; expect 25

(let ((x 10) (y 1000)) (+ (* 2 y) (* 2 x) (- 8 10)))
; expect 2018
